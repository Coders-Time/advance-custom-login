...
if ( isset($login_logo) ) {
    if ( isset($login_logo['login_logo_id']) ) {
        $login_logo_id = $login_logo['login_logo_id'];
    }
    ...
    if ( isset($login_logo['logo_show']) ) {
        $logo_show = $login_logo['logo_show'];
    }
}
...
<form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
    <div class="form-group alert border fade show">
        ...
        <div class="preview_logo mb-3">
            ...
            <?php 
                ...
                if ( $login_logo_id ) {
                    $logo_url = wp_get_attachment_image_src ( $login_logo_id, [$logo_width,$logo_height] )[0];
                }
                
            ?>

            <img src="<?php echo esc_url( $logo_url ? : $logo_default_url ); ?>" class="img-thumbnail mx-auto d-block uploaded_login_logo_img" data-id="0" alt="<?php esc_html_e( 'logo image', 'advsign' ); ?>" style="width: <?php echo $logo_width ?>px;height:<?php echo $logo_height; ?>px;">
    ...
    <div class="border p-3 mb-3 rounded">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input name="logo_width" type="range" value="<?php echo $logo_width; ?>" min="84" max="400" step="1" class="custom-range" id="logo_width">
                    <span id="logo_width_value"><?php echo $logo_width; ?></span>
                </div>
                <div class="col-md-6 form-group">
                    <label for="logo_height"><?php esc_html_e( 'Logo Image Height', 'advsign' ); ?></label>
                    <input name="logo_height" value="<?php echo $logo_height; ?>" min="84" max="200" step="1" type="range" class="custom-range" id="logo_height">
                    <span id="logo_height_value"><?php echo $logo_height; ?></span>
                </div>
            </div>
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-primary mt-5 col-md-6" name="submit" value="1"> <?php esc_html_e( 'Submit', 'advsign' ); ?> </button>
    </div>
</form>